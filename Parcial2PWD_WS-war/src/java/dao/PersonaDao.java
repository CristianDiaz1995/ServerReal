...
public class PersonaDao {
     ...
     */
    public Persona getObject(Connection conn, int ID_PERSONA) throws NotFoundException, SQLException {

          Persona valueObject = createValueObject();
          valueObject.setID_PERSONA(ID_PERSONA);
    ...
    public synchronized void create(Connection conn, Persona valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO PERSONA  ( ID_PERSONA, IDENTIFICACION, PRIMERNOMBRE, "
               + "SEGUNDONOMBRE, APELLIDOS, TELEFONO, "
               + "DIRECCION) VALUES (?, ?, ?, ?, ?, ?, ?) ";
               stmt = conn.prepareStatement(sql);

               stmt.setInt(1, valueObject.getID_PERSONA()); 
               stmt.setString(2, valueObject.getIDENTIFICACION()); 
               stmt.setString(3, valueObject.getPRIMERNOMBRE()); 
               stmt.setString(4, valueObject.getSEGUNDONOMBRE()); 
               stmt.setString(5, valueObject.getAPELLIDOS()); 
               stmt.setInt(6, valueObject.getTELEFONO()); 
               stmt.setString(7, valueObject.getDIRECCION()); 
    ...
    public void save(Connection conn, Persona valueObject) 
          ...
          String sql = "UPDATE PERSONA  SET IDENTIFICACION = ?, PRIMERNOMBRE = ?, SEGUNDONOMBRE = ?, "
               + "APELLIDOS = ?, TELEFONO = ?, DIRECCION = ? WHERE (ID_PERSONA = ? ) ";
          PreparedStatement stmt = null;

          try {
              stmt = conn.prepareStatement(sql);
              stmt.setString(1, valueObject.getIDENTIFICACION()); 
              stmt.setString(2, valueObject.getPRIMERNOMBRE()); 
              stmt.setString(3, valueObject.getSEGUNDONOMBRE()); 
     ...
     */
    public List searchMatching(Connection conn, Persona valueObject) throws SQLException {

          List searchResults;

          boolean first = true;
          StringBuffer sql = new StringBuffer("SELECT * FROM PERSONA  WHERE 1=1 ");
          ...
          if (valueObject.getSEGUNDONOMBRE() != null) {
              if (first) { first = false; }
              sql.append("AND SEGUNDONOMBRE LIKE '").append(valueObject.getSEGUNDONOMBRE()).append("%' ");
          }
    ...
    protected void singleQuery(Connection conn, PreparedStatement stmt, Persona valueObject) 
          ...
          try {
              ...
              if (result.next()) {
                   ...
                   valueObject.setSEGUNDONOMBRE(result.getString("SEGUNDONOMBRE")); 
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
          ...
          try {
              ...
              while (result.next()) {
                   ...
                   temp.setSEGUNDONOMBRE(result.getString("SEGUNDONOMBRE")); 
