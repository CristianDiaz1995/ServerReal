...
public class UsuarioDao {
    ...
    public synchronized void create(Connection conn, Usuario valueObject) throws SQLException {
          ...
          try {
               sql = "INSERT INTO USUARIO ( ID_USUARIO, ID_PERSONA, USUARIO, "
               + "CLAVE, ACTIVO) VALUES (?, ?, ?, ?, ?) ";
               stmt = conn.prepareStatement(sql);

               stmt.setInt(1, valueObject.getID_USUARIO()); 
               stmt.setInt(2, valueObject.getID_PERSONA()); 
               stmt.setString(3, valueObject.getUSUARIO()); 
               stmt.setString(4, valueObject.getCLAVE()); 
               stmt.setString(5, valueObject.getACTIVO()); 
    ...
    public void save(Connection conn, Usuario valueObject) 
          ...
          String sql = "UPDATE USUARIO SET ID_PERSONA = ?, USUARIO = ?, CLAVE = ?, "
          ...
          try {
              ...
              stmt.setString(2, valueObject.getUSUARIO()); 
    ...
    public List searchMatching(Connection conn, Usuario valueObject) throws SQLException {
          ...
          if (valueObject.getUSUARIO() != null) {
              if (first) { first = false; }
              sql.append("AND USUARIO LIKE '").append(valueObject.getUSUARIO()).append("%' ");
          }

          if (valueObject.getCLAVE() != null) {
              if (first) { first = false; }
              sql.append("AND CLAVE LIKE '").append(valueObject.getCLAVE()).append("%' ");
          }
